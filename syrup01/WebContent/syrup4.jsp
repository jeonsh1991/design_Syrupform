...
<link href="https://fonts.googleapis.com/css?family=Do+Hyeon|Nanum+Gothic|Sunflower:300" rel="stylesheet">
<style>
@import "compass/css3";
...
position: absolute;
  ...
  background: #fff;
  box-shadow: 5px 5px 10px #000;
  box-shadow: inset 0.2rem -2rem 5rem rgba(0, 0, 0, 0.1);
}
.login__check2 {
position: absolute;
  top: 7rem;
...
<div class="cont">
  <div class="demo">
    <div class="login">
      ...
      <div class="login__check2"></div>
      <div class="login__check3"></div>
      <div class="login__check4"></div>
      <div class="login__check5"></div>
      <div class="login__check6"></div>
      <div class="login__check7"></div>
      <div class="login__check8"></div>
      <div class="login__check9"></div>
      <div class="login__text01">SYRUP</div>
      <div class="login__text02">가입을 원하시는 분은 아래의 사항을 기입해주세요.</div>
      <div class="login__form">
        ...
        <div class="login__row">
          ...
          <input type="text" class="login__input pass" placeholder="Password"/>
        </div>
        <div class="login__row">
          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
    ...
    <div class="app">
      <div class="app__top">
        ...
        <div class="app__user">
          <img src="http://www.onechurch.nz/files/attach/images/7142/033/014/6ee3a98e5e4362256b8bd9c27f38777d.jpg" alt="" class="app__user-photo" />
      ...
      <div class="app__bot">
        ...
        <div class="app__meetings">
          <div class="app__meeting">
            <img src="http://www.onechurch.nz/files/attach/images/7142/033/014/6ee3a98e5e4362256b8bd9c27f38777d.jpg" alt="" class="app__meeting-photo" />
